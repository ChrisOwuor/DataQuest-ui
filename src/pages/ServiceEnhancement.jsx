...
export default function ServiceEnhancement() {
  const { active, setActive, selectedServiceStatus, setSelectedServiceStatus } =
    useContext(DataContext);
  const HandleEnhancement = (e, serv_id) => {
        ...
        <div className="mt-10 w-3/5 ">
          <div className="headi">
            <p className="block mb-2 text-lg text-start font-medium text-gray-900 dark:text-white">
              What services have been digitized but still need enhancements
            </p>
                    ...
                    >
                      ...
                      <td className=" py-4">
                        <form className="max-w-sm mx-auto">
                          <select
                            onChange={(e) => HandleEnhancement(e, serv.id)}
